...
// from table rows
var rowMenu = document.querySelectorAll(".g-row-item-manager");
...
function toggleSubMenu(element, group, targetClass) {
  if (element.target.classList.contains(targetClass)) {
    var parent = element.target.parentElement.classList;
